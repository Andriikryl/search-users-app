...
const USER_NOT_FOUND_MESSAGE = 'No user with this name. Please try anuther name.';
const LAST_REPOS_QUANTITY = 10;
    ...
    <>
      <div className="container">
        <form onSubmit={handleSubmit}>
          <h2 className={s.title}>Search <span className='titel-sub-word'>GitHub</span> user</h2>
          <input
            className={s.input}
            value={text}
            onChange={handleChange}
            placeholder="Search github profile name"
          />
